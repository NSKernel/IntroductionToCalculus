...
\setCJKmainfont[RawFeature={vertical;+vert},BoldFont=GenRyuMinTW-Bold.ttf,ItalicFont=FZKai-Z03.TTF]{GenRyuMinTW-Medium.ttf}%{DNPShueiOldStyleMinPr6N-M.otf}
...
\titlespacing*{\chapter}{10pt}{0pt}{5pt}
\titleformat{\section}{\vspace{\dimexpr -8pt+10pt}\vspace*{\dimexpr 8pt-10pt}}{}{0pt}{\raggedright\bfseries\Large\ziju{0.4}\hspace*{23pt}}
...
\newcommand{\chint}{\hbox{\lower.75ex\hbox{\scalebox{0.7}[2]{\textit{禾}}}}}
\newcommand{\chcap}[1]{\hbox{\hbox{\hspace*{.4ex}\scalebox{0.5}[0.3]{{口}}}\lower-.75ex\hbox{\hspace*{-1.4ex}\scalebox{1}[0.7]{{#1}}}}}
\newcommand{\chmcap}[1]{\hbox{\lower-.65ex\hbox{\scalebox{0.4}[0.4]{\textit{口}}}\hspace*{-.3ex}\scalebox{0.7}[1]{\textit{#1}}}}

\newcommand{\chcir}[1]{{\lower-1pt\hbox{\textcircled{\raisebox{-.5pt} {\small\textit{#1}}}}}}
